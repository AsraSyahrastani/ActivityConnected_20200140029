...
namespace Connected_PABD
{
    class Program
    {
        ...
        {
            return "data source=LAPTOP-RUF2C707\\ASRASYAHRASTANI;database=ProdiTI;MultipleActiveResultSets=True;User ID=sa;Password=Syh051002";
        }
    }
}